    ...
    "paths": {
        ...
        "/artifacts": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Название тестового набора",
                        "name": "suite",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Начальная граница времени загрузки (RFC3339)",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Конечная граница времени загрузки (RFC3339)",
                        "name": "to",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.ArtifactInfo"
                            }
                        }
                    },
                    "400": {
        ...
        "/preview": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Содержимое артефакта",
                        "schema": {
                            "type": "file"
                        }
                    },
                    "400": {
                        "description": "Некорректный запрос (отсутствует или невалидный ID)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
